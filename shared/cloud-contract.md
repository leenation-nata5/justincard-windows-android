...
- Each deck gets its own visible tab named after the deck. Section order is fixed cross-platform: Monster, Spell, Trap, Extra Deck, Side Deck; the chosen sheet sort applies inside each section.
