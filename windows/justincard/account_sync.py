    ...
    def _request(
        ...
        *,
        ...
        headers = {
            ...
            "User-Agent": "JustInCard-Windows/1.3.4",
        }
...
def replace_windows_from_payload(database: Any, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    # The account snapshot is authoritative when explicitly restored. Clearing
    # first makes deleted server entries disappear locally instead of being
    # reintroduced on the next upload.
    try:
    ...
    collection_report = database.apply_cloud_collection(collection)
    # Re-resolve each deck card to the native collection key generated by
    # apply_cloud_collection. This fixes missing deck cards after account login.
