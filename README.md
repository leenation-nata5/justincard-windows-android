...
- **Android 14.1.2** – native Kotlin/Jetpack-Compose-App mit CameraX-Livebild und ML-Kit-Scanner
...
## Android 14.1.2 Kotlin-Compiler-Hotfix

Der zweite GitHub-Fehler trat erst nach erfolgreicher AAR-Metadatenprüfung im Kotlin-Compiler auf. Die Legacy-Google-Sign-In-Klassen werden deshalb gezielt mit `play-services-auth:21.4.0` bereitgestellt. Zusätzlich wurden die Gson-Generics in Cloud-Backup und Anzeigeprofilen explizit typisiert und eine lokale `JsonArray?.orEmpty()`-Erweiterung entfernt, die Kotlin-Typauflösung im Cloud-Repository störte. Windows 1.2.7 bleibt unverändert.
