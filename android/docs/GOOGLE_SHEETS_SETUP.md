...
- **Android 13.0.11:** OAuth-Client vom Typ **Android**. Hier wird keine Desktop-Client-JSON in die APK eingebaut. Google identifiziert die App über **Paketname + SHA-1 der Signatur**.
...
Android 13.0.11 fordert zusätzlich an:
